			...
			<div className='container mx-auto max-w-6xl py-4'>
				<div className='flex gap-4 max-md:flex-col'>
					<div className='w-56 max-md:w-full'>
						<div
							className='flex flex-col space-y-2 rounded-md bg-gradient-to-b from-primary 
                        to-background px-2 py-4'
						>
							{arr.map(item => (
								<Button
									key={item.status}
					...
					<div
						className='custom-scrollbar relative min-h-[70vh] flex-1 rounded-md
                    bg-gradient-to-t from-background to-secondary pb-16'
					>
